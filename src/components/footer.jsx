...
const Footer = () => {
  return (
    <div className="max-w-[1240px] mx-auto py-10 px-3 grid lg:grid-cols-3 gap-8 text-gray-300">
      ...
      <div className="lg:col-span-2 flex ml-[8rem] sm:ml-[8rem] sm:justify-between mt-6 w-full pr-10 ">
        <ul className="flex sm:sm:space-x-8 space-x-4 space-x-4 text-black">
