  ...
  return (
    <div className="bg-rose-200  h-screen mt-10 mx-4 grid-cols-4    py-7 px-8">
      ...
      <div className="bg-zinc-50 mx-6 px-3 flex my-12 h-56 col-span-3 text-xl">
        <div><h2 className="text-slate-500 mt-8  mb-2 ml-20 border-b-slate-400"><span className="font-extrabold">Price :</span> {`₹ ${data[0].Price}`}</h2>
        <h2 className="text-slate-500 my-2 ml-20"><span className="font-extrabold"> Date :</span> {` ${data[0].start_date}`}</h2>
        <h2 className="text-slate-500 my-2 ml-20"><span className="font-extrabold">Return Date :</span> {` ${data[0].end_date}`}</h2>
      ...
      <div className="bg-zinc-50 mx-6 px-3 flex my-12 h-56 col-span-3 text-xl">
        <div><h2 className="text-slate-500 mt-8  mb-2 ml-20 border-b-slate-400"><span className="font-extrabold">Price :</span> {`₹ ${data[5].Price}`}</h2>
        <h2 className="text-slate-500 my-2 ml-20"><span className="font-extrabold">Leese Date :</span> {` ${data[5].start_date}`}</h2>
